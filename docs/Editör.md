...
Döndürme kontrol noktaları 0°, 90°, 180° ve 270° açılarına 5° tolerans içinde yardımcı snap uygular. Ctrl/Cmd diğer snap işlemlerinde olduğu gibi bu yardımı da geçici olarak atlar. Sağ IP'deki nesne ve grup döndürme picker'ları kontrol noktası yolunu kullanmaz; 1° adımla serbest dönmeye devam eder. Oransal grup boyutlandırması ve yola bağlı geometrik kısıtlar kendi kurallarını korur.
